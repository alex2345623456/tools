...
def request(flow: http.HTTPFlow):
    ...
    # Mengecek apakah URL mengandung kata "172.26.109."
    if "172.26.109." in request_data.url:
        ...
        # - URL mengandung "172.26.109." dan tanda "=" di URL
        # - URL mengandung "172.26.109." dan body mengandung tanda "=" atau ":"
        if (url_contains_equal_sign and "172.26.109." in request_data.url) or body_contains_special_chars:
