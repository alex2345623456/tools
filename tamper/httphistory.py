...
def request(flow: http.HTTPFlow):
    ...
    # Mengecek apakah URL mengandung kata "vulnweb."
    if "vulnweb." in request_data.url:
        ...
        # - URL mengandung "vulnweb." dan tanda "=" di URL
        # - URL mengandung "vulnweb." dan body mengandung tanda "=" atau ":"
        if (url_contains_equal_sign and "vulnweb." in request_data.url) or body_contains_special_chars:
