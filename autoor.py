...
def run_command(url, output_file):
    ...
    command = ['sudo', 'python3', 'or.py', '-u', url, '-p', 'payloads.txt']
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Script untuk menjalankan or.py dengan daftar URL dan menyimpan output.")
